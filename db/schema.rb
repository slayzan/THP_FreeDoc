...
ActiveRecord::Schema.define(version: 2020_07_30_160302) do
  ...
  create_table "specialisations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_specialisations_on_doctor_id"
    t.index ["specialty_id"], name: "index_specialisations_on_specialty_id"
  end
